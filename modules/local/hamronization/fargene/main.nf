process HAMRONIZATION_FARGENE_RUN {
    tag "fARGene"
    publishDir "${params.output_dir}/02_hAMRonization/fargene/", mode: 'copy'
    ...
    output:
        file("${tool_output.baseName}_fargene_standardized.tsv")
    ...
    hamronize ${tool_name} \\
        ...
        --format tsv \\
        --output ${tool_output.baseName}_fargene_standardized.tsv \\
