process HAMRONIZATION_DEEPARG_RUN {
    tag "hAMRonization"
    publishDir "${params.output_dir}/02_hAMRonization/deeparg/", mode: 'copy'
    ...
    output:
        file("${tool_output.baseName}_deeparg_standardized.tsv")
    ...
    hamronize ${tool_name} \\
        ...
        --format tsv \\
        --output ${tool_output.baseName}_deeparg_standardized.tsv \\
